...
#: Top-50 universe (transfer + triangle).  Prices are realistic 2025-2026
#: mids – only the relative scale matters for simulation.
DEFAULT_SEED_PRICES: Mapping[str, Decimal] = {
    ...
    # --- Top-50 expansion ---
    "LTC/USDT": Decimal("105"),
    "DOT/USDT": Decimal("5.2"),
    "BCH/USDT": Decimal("510"),
    "UNI/USDT": Decimal("7.8"),
    "ATOM/USDT": Decimal("5.5"),
    "ETC/USDT": Decimal("18.5"),
    "XLM/USDT": Decimal("0.30"),
    "FIL/USDT": Decimal("3.2"),
    "HBAR/USDT": Decimal("0.16"),
    "APT/USDT": Decimal("5.1"),
    "NEAR/USDT": Decimal("3.1"),
    "ARB/USDT": Decimal("0.55"),
    "OP/USDT": Decimal("1.55"),
    "SUI/USDT": Decimal("2.6"),
    "TAO/USDT": Decimal("350"),
    "RNDR/USDT": Decimal("7.2"),
    "MATIC/USDT": Decimal("0.52"),
    "TON/USDT": Decimal("3.1"),
    "SHIB/USDT": Decimal("0.000022"),
    "PEPE/USDT": Decimal("0.0000075"),
    "AAVE/USDT": Decimal("150"),
    "ENA/USDT": Decimal("0.55"),
    "WIF/USDT": Decimal("1.55"),
    "FLOKI/USDT": Decimal("0.00012"),
    "BONK/USDT": Decimal("0.000021"),
    "TIA/USDT": Decimal("4.2"),
    "INJ/USDT": Decimal("15.5"),
    "IMX/USDT": Decimal("1.25"),
    "MKR/USDT": Decimal("1500"),
    "GRT/USDT": Decimal("0.13"),
    "STX/USDT": Decimal("1.05"),
    "FET/USDT": Decimal("1.55"),
    "AR/USDT": Decimal("15.2"),
    "SEI/USDT": Decimal("0.31"),
    "JUP/USDT": Decimal("0.52"),
    "ONDO/USDT": Decimal("0.71"),
    "STRK/USDT": Decimal("1.25"),
    "WLD/USDT": Decimal("1.55"),
    "PYTH/USDT": Decimal("0.36"),
    "JTO/USDT": Decimal("2.05"),
}
...
_NETWORKS: Mapping[str, tuple[tuple[str, str, str], ...]] = {
    ...
    "AVAX": (("AVAX", "AVAX", "0.01"),),
    "TRX": (("TRC20", "TRX", "1.0"),),
    # --- Top-50 expansion: 1 network, fee tuned so $100-500 notional always clears min (=fee*10) ---
    "LTC": (("LTC", "LTC", "0.001"),),
    "DOT": (("DOT", "DOT", "0.2"),),
    "BCH": (("BCH", "BCH", "0.0008"),),
    "UNI": (("ERC20", "ETH", "2.0"),),
    ...
    "APT": (("APT", "APT", "0.02"),),
    "NEAR": (("NEAR", "NEAR", "0.05"),),
    "ARB": (("ARB", "ARBITRUM", "0.2"),),
    "OP": (("OP", "OPTIMISM", "0.1"),),
    "SUI": (("SUI", "SUI", "0.05"),),
    "TAO": (("TAO", "TAO", "0.002"),),
    "RNDR": (("RNDR", "ETH", "2.0"),),
    "MATIC": (("MATIC", "MATIC", "1.0"),),
    "TON": (("TON", "TON", "0.05"),),
    "SHIB": (("SHIB", "ETH", "1000000"),),
    "PEPE": (("PEPE", "ETH", "5000000"),),
    "AAVE": (("AAVE", "ETH", "0.02"),),
    "ENA": (("ENA", "ETH", "10"),),
    "WIF": (("WIF", "SOL", "0.5"),),
    "FLOKI": (("FLOKI", "ETH", "200000"),),
    "BONK": (("BONK", "SOL", "500000"),),
    "TIA": (("TIA", "TIA", "0.2"),),
    "INJ": (("INJ", "INJ", "0.05"),),
    "IMX": (("IMX", "ETH", "1.0"),),
    "MKR": (("MKR", "ETH", "0.001"),),
...
_SEED_INVENTORY: Mapping[str, tuple[Decimal, Decimal]] = {
    ...
    # --- Top-50 expansion ---
    "LTC": (Decimal("10"), Decimal("5")),
    "DOT": (Decimal("300"), Decimal("150")),
    "BCH": (Decimal("5"), Decimal("2")),
    "UNI": (Decimal("200"), Decimal("100")),
    "ATOM": (Decimal("300"), Decimal("150")),
    "ETC": (Decimal("80"), Decimal("40")),
    "XLM": (Decimal("5000"), Decimal("2000")),
    "FIL": (Decimal("400"), Decimal("200")),
    "HBAR": (Decimal("8000"), Decimal("3000")),
    "APT": (Decimal("400"), Decimal("200")),
    "NEAR": (Decimal("500"), Decimal("200")),
    "ARB": (Decimal("2000"), Decimal("1000")),
    "OP": (Decimal("600"), Decimal("300")),
    "SUI": (Decimal("600"), Decimal("300")),
    "TAO": (Decimal("5"), Decimal("2")),
    "RNDR": (Decimal("200"), Decimal("100")),
    "MATIC": (Decimal("2000"), Decimal("1000")),
    "TON": (Decimal("500"), Decimal("200")),
    "SHIB": (Decimal("50000000"), Decimal("20000000")),
    "PEPE": (Decimal("80000000"), Decimal("30000000")),
    "AAVE": (Decimal("10"), Decimal("5")),
    "ENA": (Decimal("2000"), Decimal("1000")),
    "WIF": (Decimal("600"), Decimal("300")),
    "FLOKI": (Decimal("5000000"), Decimal("2000000")),
    "BONK": (Decimal("50000000"), Decimal("20000000")),
    "TIA": (Decimal("300"), Decimal("150")),
    "INJ": (Decimal("80"), Decimal("40")),
    "IMX": (Decimal("800"), Decimal("400")),
    "MKR": (Decimal("1"), Decimal("0.5")),
    "GRT": (Decimal("8000"), Decimal("4000")),
    "STX": (Decimal("800"), Decimal("400")),
    "FET": (Decimal("600"), Decimal("300")),
    "AR": (Decimal("80"), Decimal("40")),
    "SEI": (Decimal("3000"), Decimal("1500")),
    "JUP": (Decimal("1800"), Decimal("900")),
    "ONDO": (Decimal("1500"), Decimal("750")),
    "STRK": (Decimal("600"), Decimal("300")),
    "WLD": (Decimal("600"), Decimal("300")),
    "PYTH": (Decimal("3000"), Decimal("1500")),
    "JTO": (Decimal("400"), Decimal("200")),
}
